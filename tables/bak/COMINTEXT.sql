CREATE TABLE `iasworld.comintext`(
  ...
  `segmod` varchar(8), 
  `sprinkler_pct` decimal(5,2), 
  `alarm_pct` decimal(5,2), 
  `ac_pct` decimal(5,2), 
  `walla_pct` decimal(5,2), 
  `wallb_pct` decimal(5,2), 
  `wallc_pct` decimal(5,2), 
  `bsmtarea` decimal(12,0), 
  `bsmtperm` decimal(12,0), 
  `bsmttype` varchar(6), 
  `no_elev` decimal(4,0), 
  `wallarea` decimal(10,0), 
...
LOCATION
  'hdfs://sqoop-node-master:9000/user/hive/warehouse/iasworld.db/comintext'
TBLPROPERTIES (
  'bucketing_version'='2', 
  'transient_lastDdlTime'='1710959683')
